...
// Static Time Picker generator. To see the directive, go down.
function showTimePicker (scope, $ionicPopup) {
  var obj = {epochTime: scope.epochTime || scope.etime, step: scope.step, format: scope.format};
    ...
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        element.on("click", function () {
          showTimePicker(scope, $ionicPopup);
        });
      }
  }
}]);